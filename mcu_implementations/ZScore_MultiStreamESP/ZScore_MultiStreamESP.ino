...
void setup() {
  ...
  frequencyHz = frequencyMhz * 1000000; // Frequency in Hz
  Serial.print("CPU frequency (MHz): ");
  Serial.println(frequencyMhz);

  clockPeriod = 1.0 / frequencyMhz * 1000; // Calculate clock period in nanoseconds
...
void loop() {
  ...
  float t = random(1, 5);  // Random value for temperature
