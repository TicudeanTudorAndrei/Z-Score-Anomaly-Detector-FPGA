...
signal inti_complete: STD_LOGIC_VECTOR(NUM_STREAMS-1 downto 0) := (others => '0');
...
begin
    if rising_edge(clk) then
        ...
        if zscore_tvalid = '1' then
            ...
            send_data <= zscore_tdata & zscore_id & full_float_number_flags;
            send_valid <= '1';
        end if;
     end if;
end process;
