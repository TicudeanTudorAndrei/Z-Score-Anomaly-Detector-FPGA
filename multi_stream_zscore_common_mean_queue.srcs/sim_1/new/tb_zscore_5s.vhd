...
entity tb_zscore_5s is
end tb_zscore_5s;

architecture tb_zscore_5s_arch of tb_zscore_5s is
...
signal x_tready: STD_LOGIC_VECTOR(4 downto 0) := (others => '0');
...
signal init_complete: STD_LOGIC_VECTOR(4 downto 0);
...
for i in 1 to 20 loop
    ...
    wait until rising_edge(aclk) and x_tready(2) = '1';
    x_tdata <= x"3fc00000"; -- 1.5
    x_tvalid <= '1';
    x_id <= x"0002";
    
    wait until rising_edge(aclk) and x_tready(3) = '1';
    x_tdata <= x"3fc00000"; -- 1.5
    x_tvalid <= '1';
    x_id <= x"0003";
    
    wait until rising_edge(aclk) and x_tready(4) = '1';
    x_tdata <= x"3fc00000"; -- 1.5
    x_tvalid <= '1';
    x_id <= x"0004";
end loop;
