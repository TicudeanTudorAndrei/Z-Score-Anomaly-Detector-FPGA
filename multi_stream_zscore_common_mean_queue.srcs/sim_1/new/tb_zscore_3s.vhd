...
entity tb_zscore_3s is
end entity;

architecture tb_zscore_3s_arh of tb_zscore_3s is
...
signal x_tready: STD_LOGIC_VECTOR(2 downto 0) := (others => '0');
...
signal init_complete: STD_LOGIC_VECTOR(2 downto 0);
