...
entity tb_zscore_4s is
end tb_zscore_4s;

architecture tb_zscore_4s_arch of tb_zscore_4s is
...
signal x_tready: STD_LOGIC_VECTOR(3 downto 0) := (others => '0');
...
signal init_complete: STD_LOGIC_VECTOR(3 downto 0);
