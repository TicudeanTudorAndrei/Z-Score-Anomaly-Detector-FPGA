...
entity tb_zscore_2s is
end entity;

architecture tb_zscore_2s_arh of tb_zscore_2s is
...
signal x_tready: STD_LOGIC_VECTOR(1 downto 0) := (others => '0');
...
signal init_complete: STD_LOGIC_VECTOR(1 downto 0);
