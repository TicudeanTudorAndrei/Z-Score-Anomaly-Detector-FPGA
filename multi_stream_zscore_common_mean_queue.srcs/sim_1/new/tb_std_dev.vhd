...
entity tb_std_dev is
end entity;

architecture tb_std_dev_arh of tb_std_dev is
...
signal mean_tready: STD_LOGIC_VECTOR(2 - 1 downto 0) := (others => '0');
...
signal std_dev_tready: STD_LOGIC := '0';
signal std_dev_id: STD_LOGIC_VECTOR(15 downto 0) := (others => '0');
...
signal x_minus_mean_id: STD_LOGIC_VECTOR(15 downto 0) := (others => '0');

signal mean_init_comp: STD_LOGIC_VECTOR(2 - 1 downto 0) := (others => '0');
...
std_dev_component: std_dev
generic map ( SAMPLE_SIZE_INT => 64,
...
std_dev_tready => std_dev_tready,
std_dev_id => std_dev_id,
...
begin
    ...
    for i in 1 to 69 loop
        wait until rising_edge(aclk) and mean_tready(0) = '1';
        case i is
        ...
        wait until rising_edge(aclk) and mean_tready(1) = '1';
        case i is
            when 1 => mean_tdata <= x"3fbbcccd"; -- 1.467187
            when 2 => mean_tdata <= x"3fbacccd"; -- 1.459375
            when 3 => mean_tdata <= x"3fb9cccd"; -- 1.451562
